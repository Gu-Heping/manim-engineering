...
MOSFET_ARROW_SIZE = 0.08
PMOS_GATE_BUBBLE_RADIUS = 0.055
MOSFET_GATE_PLATE_X = 0.28
MOSFET_CHANNEL_X = 0.42
MOSFET_DRAIN_STUB_X = 1.0
MOSFET_SOURCE_STUB_X = 0.86
MOSFET_CHANNEL_INSET = 0.08
MOSFET_SEGMENT_GAP = 0.10
MOSFET_GATE_BREAK = 0.055
MOSFET_GATE_PLATE_INSET = 0.08
MOSFET_LABEL_LEFT_OFFSET = 0.38
MOSFET_BODY_ARROW_SIZE = 0.10
MOSFET_DASH_LENGTH = 0.06
MOSFET_DASH_RATIO = 0.45
BJT_BASE_BAR_X = 0.34
BJT_STUB_X = 0.58
BJT_BAR_TOP_Y = 0.74
BJT_BAR_BOT_Y = 0.26
BJT_BAR_BRANCH_TOP_Y = 0.62
BJT_BAR_BRANCH_BOT_Y = 0.38
BJT_STUB_KNEE_C_Y = 0.76
BJT_STUB_KNEE_E_Y = 0.24
BJT_EMITTER_ARROW_SIZE = 0.12
BJT_EMITTER_ARROW_TIP_LEAD = 0.52
BJT_EMITTER_ARROW_TAIL_TRAIL = 0.32
# Fraction along emitter leg from base bar (NPN toward stub); PNP uses 1 − this.
BJT_EMITTER_ARROW_LEG_FRAC = 0.58
GND_BAR_TOP = 0.40
GND_BAR_MID = 0.28
GND_BAR_BOT = 0.18
...
POWER_LABEL_ABOVE_OFFSET = 0.14
POWER_LABEL_BELOW_OFFSET = 0.12
