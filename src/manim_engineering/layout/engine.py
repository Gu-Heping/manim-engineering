...
def pin_world_position(
    ...
    """Map a pin to world coordinates via anchor points and bounds (not renderer geometry)."""
    ...
    if pin_name not in anchors:
        ...
        raise InvalidPinError(
            ...
            f"no anchor for pin {placement.element_id}.{pin_name}"
...
class LayoutEngine:
    ...
    def layout(
        ...
        for connection in graph.connections:
            ...
            start = pin_positions[connection.pin_a.id]

            end = pin_positions[connection.pin_b.id]

            hints = merge_routing_hints(

                connection.pin_a.routing_hints,

                connection.pin_b.routing_hints,
        ...
        for node in graph.nodes:
            ...
            try:
                ...
                raise UnknownElementError(
                    ...
                    f"no circuit element for graph node: {node.id}"
